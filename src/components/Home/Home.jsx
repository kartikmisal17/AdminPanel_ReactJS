        ...
        <>
            ...
            <div className="home-container">
                ...
                <div className="hero-section">
                    <Image src="pexels-chanwalrus-958545.jpg" className="hero-image" />
                    <div className="hero-text">
                        <h1>Welcome to <span>Delicious Bites</span></h1>
                ...
                <div className="about-section">
                    <h2>Who We Are</h2>
                    <p>At <b>Delicious Bites</b>, we bring you a world of flavors crafted by expert chefs. Enjoy a delightful experience with our handpicked ingredients and signature dishes that will tantalize your taste buds.</p>
                </div>
